...
static char *dmenucmd[] = { "dmenu_run", "-p", "Launch program:", "-b", "-h", "30", "-l", "10", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbordercolor, "-sf", selfgcolor, NULL };
